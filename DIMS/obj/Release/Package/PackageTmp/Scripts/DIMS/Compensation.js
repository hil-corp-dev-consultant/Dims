...
DIMS.controller('CompensationCtrl', function ($scope, $location, $http, DIMSFactory, $compile, $routeParams) {
            ...
            if (Result != "") {
                ...
                if ($scope.Product_Type != "" && $scope.Product_Type != undefined) {
                    if ($scope.Product_Type == "Sheeting" || $scope.Product_Type == "SBU1") {
                        ...
                        else if ($scope.Product_Type == "SBU3") {
                            $("#THDefectprct").css("display", "none");
                            $("#THBasicAmount").css("display", "none");
                            $("#SupplyDetailsDiv_SBU2").hide();
                            $("#totalprodvalue").hide();
                ...
                if ((Res[0]["PRODUCT_TYPE_CODE"] == "SBU1" && new Date(Res[0]["CREATED_DATE"]) < new Date('2020-11-19')) || (Res[0]["PRODUCT_TYPE_CODE"] == "SBU8" && new Date(Res[0]["CREATED_DATE"]) < new Date('2020-11-19'))) {
                    ...
                    if ($("#Product_Type").val() == "SBU8") { $("#TYPE_OF_COMPLAINT_DIV").hide(); }
                    else { $("#TYPE_OF_COMPLAINT_DIV").show(); }
                ...
                } else if ((Res[0]["PRODUCT_TYPE_CODE"] == "SBU1" && new Date(Res[0]["CREATED_DATE"]) >= new Date('2020-11-19')) || (Res[0]["PRODUCT_TYPE_CODE"] == "SBU8" && new Date(Res[0]["CREATED_DATE"]) >= new Date('2020-11-19'))) {
                ...
                //VIKAS G, 2023 APRIL 05 SBU-8 START.
                else if (Res[0]["PRODUCT_TYPE_CODE"] == "SBU8") {
                    //$("#SubStockiest_Direct_CustomerDiv").show();
                    //$("#PartyTypeDiv").hide();
                    //$("#Is_Project_PartyDiv").show();
                    //$("#SubStockiest_CodeDiv").hide();
                ...
                //VIKAS G, 2023 APRIL 05 SBU-8 END.
                //svprasadk 27-04-2020 SBU 1 requirement to add sub stockiest master end
                var TRCode = "";
                ...
                if (CompensationScope.Product_Type == "Sheeting" || CompensationScope.Product_Type == "SBU1") {
                    ...
                    $("#RecommendedForCCSheetsDivision").css('display', 'none');
                    $("#THUnits").css("display", "none");
                    $("#THPkgQty").css("display", "none");
                    $("#THTotQtyinUnits").css("display", "none");
                    $("#THDefectprct").css("display", "none");
                    $("#THBasicAmount").css("display", "none");
                    $("#totalprodvalue").hide();
                    $("#CompensationDiv_Sheeting").hide();
                ...
                //VIKAS G , 2023 APRIL 05 SBU-8 START.
                else if (CompensationScope.ProductType_Code == "SBU8") {
                    $("#TYPE_OF_COMPLAINT_DIV").hide();
                    $(".RecomNos").text("Recommended Qty (Nos)");
                    //$("#THUnits").css("display", "block");
                    //$("#THPkgQty").css("display", "block");
                    //$("#THTotQtyinUnits").css("display", "block");
                    ...
                    TRCode = "";
                    var MSFBU8Lines = Result["MSFBU8Lines"];
                    $("#Material_Supply_Detail_Table_BU3 tbody").empty();
                    ...
                    TRCode = "";
                    var totalvalue = 0;
                    var SupplyDetailsBU8 = Result["SupplyDetailsBU8"];
                    $("#Supply_Details_TableB tbody").empty();
                    for (var i = 0; i < SupplyDetailsBU8.length; i++) {

                        TRCode = TRCode + "<tr class='MousePointer' id='SDB_" + (i + 1) + "' onclick='EditSDB(this.id)'><td>" + (i + 1) + "</td>";

                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["PRODUCT_CODE"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["PRODUCT_NAME"] + "</td>";                      
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["INVOICE_NO"] + "</td>";
                        TRCode = TRCode + "<td>" + (SupplyDetailsBU8[i]["INVOICE_DATE"]) + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["batch_no"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["SUPPLIED_QTY"] + "</td>";

                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["BREAKAGE_QTY"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["ActualDefectQty"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["TRANSPORTER"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["DEFECT_TYPE_NAME"] + "</td>";
                        TRCode = TRCode + "<td>" + (SupplyDetailsBU8[i]["DEFECT_PRCT"]).toFixed(3) + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["REMARKS"] + "</td>";
                        TRCode = TRCode + "<td>" + (SupplyDetailsBU8[i]["RATE_PER_UNIT"] * SupplyDetailsBU8[i]["ActualDefectQty"]).toFixed(3) + "</td>";
                        TRCode = TRCode + "<td style='display:none;'>" + SupplyDetailsBU8[i]["DEFECT_TYPE_CODE"] + "</td>";

                        TRCode = TRCode + "</tr>";
                        totalvalue += SupplyDetailsBU8[i]["RATE_PER_UNIT"] * SupplyDetailsBU8[i]["ActualDefectQty"];
                    ...
                    TRCode = "";
                    var RCommLinesBU8 = Result["RCommLinesBU8"];
                    $("#CompensationRecommSBU3 tbody").empty();
                    for (var i = 0; i < RCommLinesBU8.length; i++) {

                        TRCode = TRCode + "<tr class='MousePointer' id='BU3Rec_" + (i + 1) + "' onclick='EditBU3Rec(this.id)'><td>" + (i + 1) + "</td>";

                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["ProdCode"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["ProdName"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["units"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["packageqty"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["Nos"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLinesBU8[i]["TotalQtyinUnits"] + "</td>";
    ...
    $scope.SendForApproval = function () {
        ...
        else if (ProductType == "SBU3" || ProductType == "SBU8") {
        ...
        if ($scope.Compensation_Status != "Waiting for approval") {
            ...
            var Product_TypeBU8 = PT;
            if (Product_TypeBU8 == "Chemical Constructions") {
                Product_Type = "SBU8";
            }
    ...
    $scope.SaveCompensation = function () {
        ...
        if (Flag > 0) {
            ...
            else if ($scope.Product_Type == "SBU8" || $scope.Product_Type == "Insulation") {
                $scope.Product_Type = "SBU8";
            }
            ...
            if (confirm("Do you want to Save data?")) {
                ...
                DIMSFactory.saveCompensationData(Total_CompensationData).success(function (DATA) {
                    ...
                    if (response != "FALSE") {
                        ...
                        $("#ApproveSave").val("");
                        if ($scope.Product_Type == "SBU3") { SaveCompensationLinesSBU3(); }
                        else if ($scope.ProductType_Code == "SBU8") {
                            SaveCompensationLinesSBU8();
    ...
    $scope.SaveSDDataB = function () {
        try {
            ...
            var SD_Item_Type_Plant_NameB = $("#SD_Item_Type_Plant_NameB").val();
            ...
            if (Flag > 0) {
                ...
                if (SD_idB == "") {
                    ...
                    //$("#Supply_Details_TableB tbody #SDB_" + SD_idB + " td")[3].innerHTML = SD_Item_Type_Plant_NameB;
                    ...
                    $("#Supply_Details_TableB tbody #SDB_" + SD_idB + " td")[13].innerHTML = BasicAmount;
                    $("#Supply_Details_TableB tbody #SDB_" + SD_idB + " td")[14].innerHTML = Defect_Type_CODEB;
                }
                ...
                if ($("#Supply_Details_TableB tbody tr").length > 0) {
                    $("#Supply_Details_TableB tbody tr").each(function () {
                        ...
                        SupplyDetailsBU8.push({
                            ...
                            //PlantName: $("#Supply_Details_TableB tbody #" + RowId + " td")[3].innerHTML,
                            ...
                            BasicAmt: $("#Supply_Details_TableB tbody #" + RowId + " td")[13].innerHTML,
    ...
    $scope.getMaterialSupplyDetails = function (InvestigationNo) {
        ...
        DIMSFactory.getCompensationChildData(Data).success(function (response) {
            ...
            if (Result != "") {
                ...
                //$("#Site_AddressDiv").hide();
                //$("#Is_Project_PartyDiv").hide();
                //$("#lblSubStockiest_Direct_Customer").css("display", "none");
                //$("#SubStockiest_Direct_Customer").css("display", "none");
                ...
                //VIKAS G , 2023 APRIL 06 SBU-8 END
                else if (CompensationScope.ProductType_Code == "SBU8") {
                    $("#TYPE_OF_COMPLAINT_DIV").hide();
                    $(".RecomNos").text("Recommended Qty (Nos)");
                    $("#Product_Type").text("SBU8");
                    //$("#THDefectprct").css("display", "block");
                    //$("#THBasicAmount").css("display", "block");
                    $("#Defectprctdiv").show();
                    $("#BasicAmountdiv").hide();
                    ...
                    $("#Material_Supply_Detail_Table").css("display", "none");
                    $("#Mat_Sup_Det_Add").css("display", "none");
                    $("#CompensationinMetricCubicValueDivision").css("display", "block");
                    ...
                    TRCode = "";
                    var SupplyDetailsBU8 = Result["SBU8Lines"];
                    var totalvalue = 0;
                    $("#Supply_Details_TableB tbody").empty();
                    for (var i = 0; i < SupplyDetailsBU8.length; i++) {
                        ...
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["PROD_CODE"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["PROD_NAME"] + "</td>";
                        /*TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["PLANT_NAME"] + "</td>";*/
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["INVOICE_NO"] + "</td>";
                        TRCode = TRCode + "<td>" + (SupplyDetailsBU8[i]["INVOICE_DATE"]) + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["BATCHNO"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["SUPPLIED_QTY"] + "</td>";

                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["DEFECT_QTY"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["ACT_DEFECT_QTY"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["TRANSPORTER"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["DEFECT_TYPE_NAME"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["DEFECT_PRCT"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["REMARKS"] + "</td>";
                        TRCode = TRCode + "<td>" + SupplyDetailsBU8[i]["RATE_PER_UNIT"] * SupplyDetailsBU8[i]["ACT_DEFECT_QTY"] + "</td>";
                        TRCode = TRCode + "<td style='display:none;'>" + SupplyDetailsBU8[i]["DEFECT_TYPE_CODE"] + "</td>";

                        TRCode = TRCode + "</tr>";
                        totalvalue += SupplyDetailsBU8[i]["RATE_PER_UNIT"] * SupplyDetailsBU8[i]["ACT_DEFECT_QTY"];
                        console.log("Total value : " + totalvalue);
                    }
                    ...
                    TRCode = "";
                    var RCommLines = Result["SBU8Lines"];
                    ...
                    for (var i = 0; i < RCommLines.length; i++) {
                        ...
                        TRCode = TRCode + "<td>" + RCommLines[i]["PROD_CODE"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLines[i]["PROD_NAME"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLines[i]["weight_unit"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLines[i]["net_weight"] + "</td>";
                        TRCode = TRCode + "<td>" + RCommLines[i]["ACT_DEFECT_QTY"] + "</td>";
                        TRCode = TRCode + "<td>" + (RCommLines[i]["net_weight"] * RCommLines[i]["ACT_DEFECT_QTY"]).toFixed(3) + "</td>";
                ...
                //debugger;
                if ((CompensationScope.Product_Type == "SBU1" && new Date(InvestigationHeaderDetails[0]["CREATED_DATE"]) < new Date('2020-11-19')) || (CompensationScope.ProductType_Code == "SBU8" && new Date(InvestigationHeaderDetails[0]["CREATED_DATE"]) < new Date('2020-11-19'))) {
                    $("#SubStockiest_Direct_CustomerDiv").show();
                    $("#PartyTypeDiv").hide();
                    $("#Is_Project_PartyDiv").show();
                    $("#SubStockiest_CodeDiv").hide();
                    ...
                    $scope.party_type_id = 1;
                    $scope.party_type = "Stockiest";
                } else if ((CompensationScope.Product_Type == "SBU1" && new Date(InvestigationHeaderDetails[0]["CREATED_DATE"]) >= new Date('2020-11-19')) || (CompensationScope.ProductType_Code == "SBU8" && new Date(InvestigationHeaderDetails[0]["CREATED_DATE"]) >= new Date('2020-11-19'))) {
                ...
                //VIKAS G 2023 APRIL 06 SBU-8 START
                else if (CompensationScope.ProductType_Code == "SBU8") {
                    $("#TYPE_OF_COMPLAINT_DIV").hide();
                    //$("#THDefectprct").css("display", "block");
                    //$("#THBasicAmount").css("display", "block");
    ...
    $scope.getCompensationdata = function () {
        try {
            debugger
            var Compensation_Id = $("#CompFormIden").val();
...
function GetInvestigationNum(obj) {
    CompensationScope.$apply(function () {
        ...
        else if (CompensationScope.Product_Type == "SBU8" || CompensationScope.Product_Type == "Insulation") {
            CompensationScope.Product_Type = "SBU8";
        }
        ...
        //VIKAS G 2023 APRIL 06 SBU-8 START
        else if (CompensationScope.Product_Type == "SBU8") {
            $("#TYPE_OF_COMPLAINT_DIV").hide();
            //$("#THDefectprct").css("display", "block");
            //$("#THBasicAmount").css("display", "block");
            $("#Defectprctdiv").show();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == "") {
                            ...
                            if (UserCodeVal == "2021" || UserCodeVal == "2019" || UserCodeVal == "50001234" || SessionUserType == "QAM_SBU3" || SessionUserType == "RSH_BU3" || SessionUserType == "NSH_BU3" || SessionUserType == "CSM_BU3" || SessionUserType == "QAM_SBU2" || SessionUserType == "CSM_BU2" || UserType == "QAM_SBU8" || UserType == "CSM_BU8") {
                            ...
                            if (UserCode == "50000822" || UserCode == "50002304" || UserCode == "KAM") {
                                ...
                                if (StateFilter == "ALL") {
                                    WhereClause = " WHERE COMP.PRODUCT_TYPE_CODE in ('SBU3' ,'sbu8') AND COMP.DOC_STATUS!=''";
                                }
                                else {
                                    WhereClause = " WHERE COMP.STATE_CODE='" + StateFilter + "' AND COMP.PRODUCT_TYPE_CODE in ('SBU3' ,'sbu8') AND COMP.DOC_STATUS!='' ";
                                }
                            }
                            else if (UserType == "FSO_BU8" || UserType == "QAM_SBU8" || UserType == "CSM_BU8" || UserType == "QH_BU8") {

                                if (StateFilter == "ALL") {
                                    WhereClause = " WHERE COMP.PRODUCT_TYPE_CODE='SBU8' AND COMP.DOC_STATUS!=''";
                                }
                                else {
                                    WhereClause = " WHERE COMP.STATE_CODE='" + StateFilter + "' AND COMP.PRODUCT_TYPE_CODE='SBU8' AND COMP.DOC_STATUS!='' ";
                                }
                            }
                            else {
