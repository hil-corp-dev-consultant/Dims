            ...
            if (FormIdentity == "" || FormIdentity == null || FormIdentity == undefined) {
                ...
                $http({
                    ...
                    if (response.data == "FALSE") {
                        ...
                        if (HeaderData[0]["FREQUENCY_BASED"] == "True") {
                        ...
                        if (HeaderData[0]["ISSUE_CREDIT_NOTE"] == "True") {
                        ...
                        else if (HeaderData[0]["PRODUCT_TYPE_NAME"] == "SBU2" || HeaderData[0]["PRODUCT_TYPE_NAME"] == "SBU3") {
            ...
            if (Flag > 0) {
                ...
                $("#Supply_Details_TableSBU3 tbody tr").each(function () {
                    ...
                    SupDetSD_BU3.push({
                        ...
                        InvNo: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[3].innerHTML,
                        InvDate: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[4].innerHTML,
                        BatNo: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[5].innerHTML,

                        Supp: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[6].innerHTML,
                        DefQty: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[7].innerHTML,
                        ActDefQty: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[8].innerHTML,

                        Transport: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[9].innerHTML,
                        DefName: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[10].innerHTML,
                        Remarks: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[11].innerHTML,

                        DefCode: $("#Supply_Details_TableSBU3 tbody #" + RowId + " td")[12].innerHTML
                    });
                });
                ...
                var InvestigationData = JSON.stringify({
                    ...
                    TYPE_OF_COMPLAINT: $("#TYPE_OF_COMPLAINT_ID").val(),
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == "") {
                            ...
                            if (UserCode == "2021" || UserCode == "2019" || UserCode == "50001234" || SessionUserType == "QAM_SBU3" || SessionUserType == "RSH_BU3" || SessionUserType == "NSH_BU3" || SessionUserType == "CSM_BU3" || SessionUserType == "QAM_SBU2" || SessionUserType == "CSM_BU2" || SessionUserType == "Plant_MHD" || SessionUserType == "MDO") {
