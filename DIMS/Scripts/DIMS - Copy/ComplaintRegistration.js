...
function GetCustomer(obj) {
    RegistrationScope.$apply(function () {
        ...
        //RegistrationScope.Customer_Type_CODE = $(obj).children().eq(3).html();
        //RegistrationScope.Customer_Type = $(obj).children().eq(4).html();

        //RegistrationScope.Contact_StateCode = $(obj).children().eq(5).html();
        //RegistrationScope.Contact_State = $(obj).children().eq(6).html();

        //RegistrationScope.Contact_AreaCode = $(obj).children().eq(7).html();
        //RegistrationScope.Contact_Area = $(obj).children().eq(8).html();
        //RegistrationScope.Contact_City = $(obj).children().eq(9).html();
        //RegistrationScope.Customer_Email = $(obj).children().eq(10).html();

        //RegistrationScope.Contact_Person = ($(obj).children().eq(11).html()).replace("&amp;", "&");
        //RegistrationScope.Contact_Person = "";
        //RegistrationScope.Contact_Number = $(obj).children().eq(12).html();
        //RegistrationScope.Customer_Fax = $(obj).children().eq(13).html();
        //RegistrationScope.Customer_Fax = "";
