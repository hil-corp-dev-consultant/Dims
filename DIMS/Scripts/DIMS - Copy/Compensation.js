    ...
    if ($routeParams.ID == undefined || $routeParams.ID == "") {
        ...
        DIMSFactory.getCompensationData(Data).success(function (response) {
            ...
            if (Result != "") {
                ...
                if (Res[0]["INVOICE_BASED"] == "" || Res[0]["INVOICE_BASED"] == null || Res[0]["INVOICE_BASED"] == "False") {
                ...
                if (Res[0]["PERIOD_BASED"] == "" || Res[0]["PERIOD_BASED"] == null || Res[0]["PERIOD_BASED"] == "False") {
                ...
                if (Res[0]["ISSUE_CREDIT_NOTE"] == "True") {
                ...
                if (Res[0]["PRODUCT_TYPE_CODE"] == "SBU1") {
                ...
                //svprasadk 27-04-2020 SBU 1 requirement to add sub stockiest master end
                var MaterialSupplyDetails = Result["MaterialSupplyLinesData"];
                var TRCode = "";
    ...
    $scope.getMaterialSupplyDetails = function (InvestigationNo) {
        ...
        DIMSFactory.getCompensationChildData(Data).success(function (response) {
            ...
            if (Result != "") {
                ...
                if (InvestigationHeaderDetails[0]["Invoice_Based"] == "" || InvestigationHeaderDetails[0]["Invoice_Based"] == null || InvestigationHeaderDetails[0]["Invoice_Based"] == "False") {
                    $scope.Invoice_Based = false;
                    $("#InvoiceBasedDiv").hide();
                ...
                if (InvestigationHeaderDetails[0]["FREQUENCY_BASED"] == "" || InvestigationHeaderDetails[0]["FREQUENCY_BASED"] == null || InvestigationHeaderDetails[0]["FREQUENCY_BASED"] == "False") {
                    $scope.Period_Based = false;
                ...
                if (InvestigationHeaderDetails[0]["ISSUE_CREDIT_NOTE"] == "True") {
                    $scope.CompensationIssueCreditNote = true;
                    $scope.IssueCredited();
                }
                else {
                ...
                var MaterialSupplyDetails = Result["MaterialSupplyDetails"];
                var TRCode = "";
                $("#Material_Supply_Detail_Table tbody").empty();
...
function GetInvestigationNum(obj) {
    CompensationScope.$apply(function () {
        ...
        if ($(obj).children().eq(42).html() == "True") {
