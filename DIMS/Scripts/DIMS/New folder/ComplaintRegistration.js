...
//VIKAS G, 9-3-2022 AS PER jOSEPH REQUIREMENT ADDING BASIC AMOUNT IN THE COMPLAINT REGISTRATION SUPPLY DETAILS END.
        ...
        try {
            ...
            if (FormIdentity == "" || FormIdentity == undefined) {
                ...
                if (UserType_ID == "FSO" || UserType_ID == "FSO_BU2" || UserType_ID == "FSO_BU3") {
            ...
            //svprasadk 21-12-2020 SBU3 requirement adding checkbox to product master end
                        ...
                        //VIKAS G, 9-3-2022 AS PER jOSEPH REQUIREMENT ADDING BASIC AMOUNT IN THE COMPLAINT REGISTRATION SUPPLY DETAILS.
                            if (HeaderData[0]["PRODUCT_TYPE_CODE"] == "SBU3" && HeaderData[0]["PRODUCT_CATEGORY_CODE"] != "36"){
                            TRCode = TRCode + "<td>" + SUP_Lines[i]["RATE_PER_UNIT"] * SUP_Lines[i]["BreakageQtyNos"] + "</td>";
                                        }                            
                            TRCode = TRCode + "<td style='display:none'></td>";
...
console.log(totalvalue);
 //VIKAS G, 9-3-2022 AS PER jOSEPH REQUIREMENT ADDING BASIC AMOUNT IN THE COMPLAINT REGISTRATION SUPPLY DETAILS END.
                        ...
                        if (HeaderData[0]["DOC_STATUS"] == "DRAFT") {
                            ...
                            if ((HeaderData[0]["DOC_STATUS"] == "Approved") && (UserType == "CSM" || UserType == "QH" || UserType == "CSM_BU2" || UserType == "CSM_BU3")) {
 ...
 if ($("#Product_Type").val() == "" || $("#Product_Type_CODE").val() == "") {
            ...
            var Material_Belongs_To_CODE_SBU2 = $("#Material_Supply_Detail_Table").find("tr:eq(1)").find("td:eq(5)").text();
            var Product_Supplied_From_CODE_SBU2 = $("#Material_Supply_Detail_Table").find("tr:eq(1)").find("td:eq(7)").text();
            var MSD_Name_CODE_SBU2 = $("#Material_Supply_Detail_Table").find("tr:eq(1)").find("td:eq(9)").text();
            var Invoice_no = $("#SD_InvoiceNo_SBU2").val();
            var Invoice_no1 = Invoice_no.substring(0, 4)
            if ((Invoice_no1 == Material_Belongs_To_CODE_SBU2) || (Invoice_no1 == MSD_Name_CODE_SBU2)) {
            var FLG = 0;
            ...
            alert("Please Check Plant or Invoice No.");
            return;
        }
 ...
 var FLG = 0;
        ...
        DIMSFactory.getMasterData(Data).success(function (response) {
            ...
            if (MasterType == "StockistMaster") {
                ...
                //$("#PopUpTable thead tr th:nth-child(8)").hide();

                //$("#PopUpTable tbody tr td:nth-child(5)").hide();
                //$("#PopUpTable tbody tr td:nth-child(8)").hide();
            }
            else {
...
//debugger
        ...
        if (UserType_ID == "FSO" || UserType_ID == "FSO_BU2" || UserType_ID == "FSO_BU3") {
            ...
            else if ($(obj).children().eq(1).html() == "SBU1") {
                ...
                $.ajax({
                    ...
                    success: function (response) {               
                        ...
                        if (response == "") {
                            ...
                            if (UserCode == "2021" || UserCode == "2019" || UserCode == "50001234" || SessionUserType == "QAM_SBU3" || SessionUserType == "RSH_BU3" || SessionUserType == "NSH_BU3" || SessionUserType == "CSM_BU3" || SessionUserType == "QAM_SBU2" || SessionUserType == "CSM_BU2" || SessionUserType == "Plant_MHD") {
                            ...
                            if (UserType == "STOCKIST" || UserType == "BU2_STK" || UserType == "BU3_STK") {
                            ...
                            else if (UserCode == "50002213" || UserCode == "50002304" || UserCode == "KAM") {                                
                                if (StateFilter == "ALL") {
                            ...
                            else if (UserCode == "2019" || UserCode == "2021" || UserCode == "50001234" || UserType == "QAM_SBU3" || UserType == "CSM_BU3" || UserType == "Plant_MHD" || UserType == "MDO") {
                                ...
                                WhereClause = " WHERE RC.STATE_CODE='" + StateFilter + "' AND RC.PRODUCT_TYPE_CODE='SBU3' AND RC.DOC_STATUS!='' AND (RC.CREATED_BY='" + UserCode + "' OR RC.SALES_REPRESENTATIVE_CODE='" + UserCode + "') ";
                            }
                            else if (UserType == "FSO_BU2_BU3") {
                                WhereClause = " WHERE RC.STATE_CODE='" + StateFilter + "' AND (RC.PRODUCT_TYPE_CODE='SBU2' or RC.PRODUCT_TYPE_CODE='SBU3') AND RC.DOC_STATUS!='' AND (RC.CREATED_BY='" + UserCode + "' OR RC.SALES_REPRESENTATIVE_CODE='" + UserCode + "') ";
                            }
