...
namespace DIMS.Controllers
{
    ...
    public class ComplaintRegistrationICCController : Controller
    {
        [Authorize]
        public JsonResult FillCMSStateFilter()
        {
            ...
            try
            {
                ...
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/FillCMSStateFilter");
        ...
        public JsonResult SaveComplaint(string RegistrationData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveComplaint");
        ...
        public ActionResult GetComplaint(string Identity)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetComplaint");
        ...
        public ActionResult GetInvestigationForEdit(string Identity)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetInvestigationForEdit");
                JR.Data = clt.MakeRequest("POST", Identity, iAppUtils.HttpContentType.json).ResponseBody;
            }
            catch (Exception EX)
            {
        ...
        public ActionResult SaveInvestigation(string InvestigationData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveInvestigation");
        ...
        public JsonResult SendForApproval(string ApprovalData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SendForApproval");
        ...
        public JsonResult MakeApproval(string ApprovalData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/MakeApproval");
                JR.Data = clt.MakeRequest("POST", ApprovalData, iAppUtils.HttpContentType.json).ResponseBody;
                ...
                //    {
                //        clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetApprovedCompensationData");
        ...
        public JsonResult SaveComplaintTable(string TableRegistrationData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveComplaintTable");
        ...
        public JsonResult SaveInvestigationTable(string TableRegistrationData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveInvestigationTable");
                JR.Data = clt.MakeRequest("POST", TableRegistrationData, iAppUtils.HttpContentType.json).ResponseBody;
            }
            catch (Exception EX)
            {
        ...
        public JsonResult GetUserType(string UserCode)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetUserType");
        ...
        public ActionResult getCompensationChildData(string Data)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetInvestigationChildData_Compensation");
        ...
        public ActionResult SaveCompensationData(string SaveData)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveCompensationData");
        ...
        public ActionResult UpdateCreditNoteData(string SaveData)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/UpdateCreditNoteData");
                JR.Data = clt.MakeRequest("POST", SaveData, iAppUtils.HttpContentType.json).ResponseBody;
                return Json(new
                {
                    tabledata = JR.Data.ToString()
        ...
        public ActionResult getCompensationData(string Data)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetCompensationData");
                JR.Data = clt.MakeRequest("POST", Data, iAppUtils.HttpContentType.json).ResponseBody;
                return Json(new
                {
                    tabledata = JR.Data.ToString()
        ...
        public ActionResult getReportListData(string Data)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetReportsListData");
                JR.Data = clt.MakeRequest("POST", Data, iAppUtils.HttpContentType.json).ResponseBody;
                return Json(new
                {
                    tabledata = JR.Data.ToString()
        ...
        public JsonResult AutoAssignComplaint(string AssignData)
        {
            ...
            {
                //UserProperties UP = (UserProperties)Session["UP"];
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/AutoAssignComplaint");
        ...
        public JsonResult SaveCCSheetsDataToDB(string CCSheetsData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveCCSheetsDataToDB");
        ...
        public JsonResult SaveCorrectiveMeasure(string CorrectiveMeasureData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveCorrectiveMeasure");
        ...
        public JsonResult GetTopDataToBottom(string IPData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetTopDataToBottom");
        ...
        public JsonResult GetCorrectiveMeasureDataForEdit(string IPData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetCorrectiveMeasureDataForEdit");
                JR.Data = clt.MakeRequest("POST", IPData, iAppUtils.HttpContentType.json).ResponseBody;
        ...
        public JsonResult GetPlantCodeForUserQAMPL(string UserCode)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetPlantCodeForUserQAMPL");
                JR.Data = clt.MakeRequest("POST", UserCode, iAppUtils.HttpContentType.json).ResponseBody;
        ...
        public JsonResult SaveCompensationLinesSBU3(string IPData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveCompensationLinesSBU3");
                JR.Data = clt.MakeRequest("POST", IPData, iAppUtils.HttpContentType.json).ResponseBody;
        ...
        public JsonResult SaveCompensationLinesSBU2(string IPData)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/SaveCompensationLinesSBU2");
                JR.Data = clt.MakeRequest("POST", IPData, iAppUtils.HttpContentType.json).ResponseBody;
        ...
        public JsonResult CCSheetCalculation(string ProductArray)
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/CCSheetCalculation");
        ...
        public JsonResult GetCMSBUHeadDataClient()
        {
            ...
            try
            {
                HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetCMSBUHeadDataClient");
        ...
        public ActionResult GetInvoiceValidation(string Data)
        {
            ...
            {
                JsonResult JR = new JsonResult();
                iAppUtils.HttpClient clt = new iAppUtils.HttpClient(ConfigurationManager.AppSettings["ServiceURL"] + "ComplaintManagementICC/GetInvoiceValidation");
                JR.Data = clt.MakeRequest("POST", Data, iAppUtils.HttpContentType.json).ResponseBody;
                return Json(new
                {
